...
const TRANSLATIONS = {
  en: {
    ...
    bgmDesc:          'Enable or disable the background music that plays across all pages.',
    toastBgmOn:       'Background music enabled.',
    toastBgmOff:      'Background music disabled.',
  ...
  id: {
    ...
    bgmDesc:          'Aktifkan atau nonaktifkan musik latar yang diputar di semua halaman.',
    toastBgmOn:       'Musik latar diaktifkan.',
    toastBgmOff:      'Musik latar dinonaktifkan.',
    animTitle:        'Animasi',
